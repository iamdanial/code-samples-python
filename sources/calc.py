'''
The 'calc' library contains the 'multiply2' function that takes 2 values and multiply
them together. If either value is a string (or both of them are) 'multiply2' ensures
they are both strings, thereby resulting in a concatenated result.
NOTE: If a value submitted to the 'multiply2' function is a float, it must be done so
